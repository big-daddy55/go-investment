...
require base_path("api/createaccesstoken.php");
...
$body = array(
    ...
    'payerMessage' => 'Go Investment MTN Payment',
...
// Check for errors
 if (curl_errno($curl)) {
   ...
   if ($httpcode == 202) {
     echo 'Request successfully, Ref ID : '. $reference_id .' & response status code is : ' . $httpcode . ' from ' .$phone;
   } else {
